...
def get_symbol(args, arg_params, aux_params):
    ...
    out = ssr.get_symbol(stage_num,lambda_local,lambda_d)
    y=mx.symbol.Variable('label_age')
...
def parse_args():
  ...
  # general
  parser.add_argument('--data-dir', default='../datasets/wiki', help='training set directory')
  ...
  parser.add_argument('--verbose', type=int, default=4000, help='do verification testing and model saving every verbose batches')
